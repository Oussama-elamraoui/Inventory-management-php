...
$sql="INSERT INTO  client(nom , prenom, email_client, mobile_client,adresse_client) VALUES ('$nom','$prnm','$mail','$mob','$adr')";
...
<?php }
	...
	<?php 
        ...
        <table style="background-color: white ; font-family: serif;"  align="center" cellspacing="0" cellpadding="0" width=80% border="2" class="tableauacc">
			 	...
			 	<thead>
			 		<tr border="2">
			 			<th >id</th><th>nom du client</th><th>prenom client</th><th >email client</th><th>numero de telephone</th><th>adresse</th>
			 		</tr>
			 	</thead>
			 	<tbody>
			 		<?php 
