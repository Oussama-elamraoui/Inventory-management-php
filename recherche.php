...
<div align="center">
	<form method="POST" action="prd_critique.php">
     <table>
     	
     		<label ><h3>Recherche par quantite critique:</h3></label></br>
     		<p><input type="number" value="" name="critique"></p>
     		<button type="submit" class="btn btn-primary">Search</button>
     	
     </table>
		
	</form>
	<form method="POST" action="recherche_id.php">
     <table>
     	
     		<label ><h3>Recherche par l'id de produit:</h3></label></br>
